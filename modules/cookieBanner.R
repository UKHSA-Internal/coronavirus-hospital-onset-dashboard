...
cookieBanner <- function(id){
  tags$div(
      ...
      <div class="govuk-grid-row">
        <div class="govuk-grid-column-two-thirds">
          <div class="gem-c-cookie-banner__message">
            ...
            <p class="govuk-body">We use <a class="govuk-link js-goto-cookies" href="#!/cookies">cookies to collect information</a> about how you use GOV.UK. We use this information to make the website work as well as possible and improve government services.</p>
          </div>
          <div class="gem-c-cookie-banner__buttons">
            ...
            <div class="gem-c-cookie-banner__button gem-c-cookie-banner__button-settings">
              <a id="set-cookie-prefs" class="gem-c-button govuk-button gem-c-button--inline govuk-!-margin-bottom-0 js-goto-cookies" role="button" data-module="track-click" data-track-category="cookieBanner" data-track-action="Cookie banner settings clicked" href="#!/cookies">Set cookie preferences</a>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="gem-c-cookie-banner__confirmation govuk-width-container" tabindex="-1" style="display: none;">
      <p class="gem-c-cookie-banner__confirmation-message govuk-body">You’ve accepted all cookies. You can <a class="govuk-link js-goto-cookies" href="#!/cookies" data-module="track-click" data-track-category="cookieBanner" data-track-action="Cookie banner settings clicked from confirmation">change your cookie settings</a> at any time.</p>
