        ...
        <div class="govuk-grid-column-two-thirds">
          ...
          <div class="gem-c-cookie-banner__buttons">
            ...
            <div class="gem-c-cookie-banner__button gem-c-cookie-banner__button-settings">
              <a class="gem-c-button govuk-button gem-c-button--inline govuk-!-margin-bottom-0" role="button" data-module="track-click" data-track-category="cookieBanner" data-track-action="Cookie banner settings clicked" href="/help/cookies">Set cookie preferences</a>
            </div>
          </div>
        </div>
      </div>
